...
def generate_vocabulary_planes():
    ...
    spellings, projected as Planes list literals -- inline data a lexer
    written in Planes can bind directly, with no `read` effect and
    nothing for its own effect surface to declare."""
