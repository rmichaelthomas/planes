...
def test_every_valid_planes_file_in_the_repo_still_parses():
    """The 33-file corpus (8 root files + 25 demo/ files, excluding
    ...
    (S2 §A.6 / Phase 5), 33 since demo/mcp/v1.planes and v2.planes entered
    it (Sprint A H3) -- each analysed through the real module loader
