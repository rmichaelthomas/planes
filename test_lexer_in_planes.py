...
def test_corpus_is_the_33_files_report_grammar_amber_counts():
    ...
    (S2 §A.6 / Phase 5, the state-record idiom made corpus evidence); 33
    since demo/mcp/v1.planes and v2.planes entered it (Sprint A H3)."""
    assert len(CORPUS) == 33, f"expected 33 corpus files, found {len(CORPUS)}"
